...
{
    Lcd_cursor(&lcd, 0, 1);
    Lcd_string(&lcd, "NAVEEN KUMAR S\n");

    Lcd_cursor(&lcd, 1, 1);
    Lcd_string(&lcd, "212223040129\n");
...
![PMC O-4](https://github.com/user-attachments/assets/616782d4-cefd-467e-82d0-dabb6962e208)

![O2-4](https://github.com/user-attachments/assets/48f03cc7-776b-4443-bcce-dafc95bc6bde)


 
## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
![O3-4](https://github.com/user-attachments/assets/cf30e4bd-221a-4420-88dc-d6f722e1cd9d)
